...
<body>
    ...
    <span><marquee>This is Library Management System. Library open at 8:00 Am
         and close at 8:00 Pm</marquee></span><br><br>
            ...
            <div class="form">
           <h1>UPDATE YOUR DETAILES</h1><br>
                <form action="update.php" method="POST">

                <div class="form1">
                <label>Full Name:</label><br>
                <input type="text" value="<?php echo $name;?>" class="form"><br>
                </div>

                <div class="form1">
                <label>Mobile no:</label><br>
                <input type="number"  value="<?php echo $mobile;?>" class="form"> <br>
                </div>

                <div class="form1">
                <label>E-mail:</label><br>
                <input type="email"  value="<?php echo $email;?>" class="form"><br> 
                </div>
 
                <div class="form1">
                <label>Password:</label><br>
                <input type="text"  value="<?php echo $pass;?>" class="form"><br>
                </div>

                <div class="form1">
                <label>Address</label><br>
                <textarea id="" cols="40" rows="5" value="<?php echo $address;?>" ></textarea><br><br>
                </div>
